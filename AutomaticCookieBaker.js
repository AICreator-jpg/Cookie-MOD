if (typeof window.CustomAutomationMod === "undefined") {
  window.CustomAutomationMod = {
    ...
    init: function() {
      ...
      window.addCustomSpells = function(count) {
        try {
      ...
      document.getElementById("au-g").onclick = function() { window.addCustomSpells(1); };
      document.getElementById("au-g10").onclick = function() { window.addCustomSpells(10); };
      document.getElementById("au-g100").onclick = function() { window.addCustomSpells(100); };

    ...
    init: function() {
        ...
        function createTrueFtHoFMathRandom(seedStr) {
            ...
            return function() {
                let top = 0;
                for (let m = 0; m < 6; m++) {
                    top = top * width + drawSingleByte();
                }

                let bot = 0;
                for (let m = 0; m < 7; m++) {
                    bot = bot * width + drawSingleByte();
                }

                let raw = (top * 2097152 + bot) / 9007199254740992;
            ...
            if (spellsCount !== Game.fthof_planner_last_count || Game.fthof_planner_html_cache === "") {
                ...
                let html = `
                    <div style="text-align: center; margin-bottom: 10px;">
                        <h3 style="color: #ecc45e; font-size: 18px; margin: 0;">FtHoF プランナー (v78.0.0)</h3>
